        ...
        <div className="flex flex-col max-w-5xl">
          <div className="animate-fade-in-up">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-montserrat font-bold text-kind-navy mb-6">
              Transforming Businesses Through <span className="text-kind-blue">One of a <span className="text-kind-blue">Kind</span> Acquisition <span className="text-kind-navy">Playbook</span></span>
            </h1>
